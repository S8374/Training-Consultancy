...
export default function Contact() {
    return (
        <section className="min-h-screen  dark:bg-gray-900">
            {/* SEO Helmet */}
      <Helmet>
        <title>Contact Us - Our Services and Contact</title>
        <meta
          name="description"
        ...
        <meta name="author" content="Your Company Name" />
            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="container  mx-auto">
                    ...
                    <img className="object-cover w-full h-64  lg:h-96" src="https://images.unsplash.com/photo-1568992688065-536aad8a12f6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1632&q=100" alt="" />
                ...
                <div className="container px-6 py-12 mx-auto">
                    ...
                    <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3">
                        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1">
                            ...
                            <div>
                                <span className="inline-block p-3 text-blue-500 rounded-full  dark:bg-gray-800">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5">
