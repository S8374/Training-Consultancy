...
export default function ServceImage() {
    return (
        <section className="dark:bg-gray-100 mt-6 ">
        <div className="container flex flex-col-reverse mx-auto lg:flex-row">
            ...
            <div className="lg:w-1/2 xl:w-3/5 dark:bg-gray-100">
                <div className="flex items-center justify-center p-4 md:p-8 lg:p-12">
                    <img src="https://media.istockphoto.com/id/1454530399/photo/business-people-in-the-office.jpg?s=612x612&w=0&k=20&c=qbzcFUSdOJCXk349s7nQJOn7jrWAhc5ViaIC0l4HFfY=" alt="" className="rounded-lg shadow-lg dark:bg-gray-500 aspect-video sm:min-h-96" />
                </div>
            </div>
        </div>
